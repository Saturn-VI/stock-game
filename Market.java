...
public class Market {
    ...
    public static String randomEvent(Stock stock) {
        ...
        if (goodOrBad == 0) {
            ...
            randomMessage = GOODEVENTS[(int)(Math.random()*GOODEVENTS.length)];
    ...
    public static String hiddenEvent(Stock stock) {
        ...
        return stock.getSymbol() + " got a hidden sentiment of " + hiddenSentiment;
    }
    ...
    public static double getProfitPercentageOnStock(
        ...
        return (initialCost + getCurrentTraderProfitOnStock(traderId, stockName)) / initialCost;
    }
